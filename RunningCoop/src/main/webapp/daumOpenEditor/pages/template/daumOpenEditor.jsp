		...
		<div id="tx_trex_container" class="tx-editor-container">
							...
							<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
								...
								<div class="tx-menu-footer">
									<img class="tx-menu-confirm"
										src="daumOpenEditor/images/icon/editor/btn_confirm.gif?rv=1.0.1"
										alt="" /> <img class="tx-menu-cancel" hspace="3"
										src="daumOpenEditor/images/icon/editor/btn_cancel.gif?rv=1.0.1"
										alt="" />
								</div>
							</div>
						</li>
			...
			<div id="tx_canvas" class="tx-canvas">
				<div id="tx_loading" class="tx-loading">
					<div>
						<img src="daumOpenEditor/images/icon/editor/loading2.png"
			...
			<div id="tx_resizer" class="tx-resize-bar">
				...
				<img id="tx_resize_holder"
					src="daumOpenEditor/images/icon/editor/skin/01/btn_drag01.gif"
			...
			<div class="tx-side-bi" id="tx_side_bi">
				<div style="text-align: right;">
					<img hspace="4" height="14" width="78" align="absmiddle"
						src="daumOpenEditor/images/icon/editor/editor_bi.png" />
				</div>
			</div>
			<!-- 편집영역 끝 -->
			<!-- 첨부박스 시작 -->
				...
				<div id="tx_attach_box" class="tx-attach-box">
					<div class="tx-attach-box-inner">
						<div id="tx_attach_preview" class="tx-attach-preview">
							<p></p>
							<img src="daumOpenEditor/images/icon/editor/pn_preview.gif"
