...
<body>
	...
	<div class = "mainContain">
		...
		<form class = "LoginBox" action="./ckLogin.do" method="post">
			...
			<div class = "enter">
				<input type = "submit" class="accountBtn" id = "login" value="로그인" style="width: 300px; height: 40px; font-size: 14pt; border-radius: 4px; background-color: #5cb85c; color: #fff;">
			</div>
		</form>
		</div>
	</div>
