...
<title>Running Co-op :: 시스템 관리자 - 문의 게시판</title>
...
<body>
	...
	<div id="sys_container">
		...
		<div class="adm_search_area">
			<form action="./sysQnaMgr.do" method="post">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<c:if test="${ list.get('SBR_STEP') > 0 }">
							<td><a href="./viewQna.do?sbr_uuid=${ list.SBR_UUID }"><img alt="reply" src="images/sysBoard/reply.png"/>${ list.SBR_TITLE }</a></td>
						</c:if>
						<c:if test="${ list.get('SBR_STEP') == 0 }">
