...
<title>Running Co-op :: 시스템관리자 - 문의글 보기</title>
<link rel="stylesheet" href="css/main.css" type="text/css"/>
<script type="text/javascript" src="http://code.jquery.com/jquery-latest.js"></script>
<script type="text/javascript">
	function back() {
		location.href="./sysQnaMgr.do";
	}
...
%>
	...
	<div id="sys_container">
		...
		<div class="adm_qna_view">
			...
			<input type="button" class="body_btn adm_reply_write" value="답글 작성" onclick="location.href='./writeReply.do?sbr_uuid=${ view.get('SBR_UUID') }'"/>
			<input type="button" class="body_btn adm_qna_edit" value="게시글 수정" id="editBtn" onclick="Edit()" style="display: none" /> 
			<input type="button" class="body_btn adm_qna_delete" value="게시글 삭제" id="deleteBtn" onclick="Delete()" style="display: none" /> 
			<input type="button" class="body_btn adm_qna_back" value="목록으로" onclick="back()" />
		</div>
	</div>
	<div id="sys_footer">
